...
var pizzaElementGenerator = function(i) {
  ...
  //using col is more efficient for dividing the div
...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
	  // ***No need to redefine the container variable in each for loop.
...
// Created a object of pizza div and rendered to page once populated
...
function updatePositions() {
  ...
  //updated to use the var scrollTop	  
